...
urlpatterns = [
    ...
    path('', login_required(views.home), name='personel'),
    path('api/queue-data/', views.queue_data_api, name='queue_data_api'),
    path('new/home/', views.new_home, name='new_personel'),  # Added trailing slash
    path('done_current_number/', login_required(views.done_current_number), name='done_current_number'),  # Added trailing slash
    path('standby/', login_required(views.standby), name='standby'),  # Added trailing slash
    path('priority_standby/', login_required(views.priority_standby), name='priority_standby'),  # Added trailing slash
    path('end_all_appointments/', login_required(views.end_all_appointments), name='end_all_appointments'),  # Added trailing slash

"""
Django settings for my_queue project.
...
SECRET_KEY = 'django-insecure-j%z_ku7c)q*u$dalp(jf9q$kuza79)0-f#1rq7dsgshl)re5py'
...
# Daphne
ASGI_APPLICATION = 'my_queue.asgi.application'
...
WSGI_APPLICATION = 'my_queue.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'db.sqlite3',  # The database file will be located in the project root directory
    }
}
